  ...
  return (
    <div className="flex flex-row justify-between w-full">
      <div className="flex flex-row justify-center">
        <div className="flex justify-center px-2 hover:bg-slate-200 cursor-pointer rounded-sm" onClick={onToggleLeftSidebar}>
          <button>
      ...
      <div className="flex flex-row">
        ...
        <div className="px-0.5 flex flex-row justify-center">
          <button className="flex px-4 py-1 m-1 items-center justify-center rounded-3xl border bg-orange-500 text-white cursor-pointer hover:border-2 hover:border-gray-400" style={{ backgroundColor: getRandomColorWithOpacity(0.7) }}>P</button>
        </div>:
        <>
          <div className="px-0.5 flex flex-row justify-center">
